...
checkpoint_dir = '../checkpoints_rec_1_lay_small' + str(newx) +  '_' + str(newy) + '/'
...
myNet = SegCNNRecSimple(n_rec_layers = 1, hidden_sizes = [128], kernel_sizes = [3])
myNet.train(False)
